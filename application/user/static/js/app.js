$(function($) {
    ...
    function() {
        ...
        if (!$item.hasClass('open')) {
            ...
            $(this).find('.fa.fa-angle-right').attr("src","/public/img/shouqi01.png");

            var $icon = $(this).find('.fa-angle-right');
            $icon.removeClass('fa-angle-right');
            $icon.addClass('fa-angle-down');
        }else{
        	$(this).find('.fa.fa-angle-right').attr("src","/public/img/zhankai01.png");
        }
        ...
        if ($item.hasClass('open')) {
            ...
            //测试 $item.parent().find('.nav-header.open .dropdown-toggle .fa.fa-angle-right').attr("src","/public/img/shouqi01.png");
            $('.nav-header .dropdown-toggle .fa.fa-angle-right').attr("src","/public/img/zhankai01.png");
